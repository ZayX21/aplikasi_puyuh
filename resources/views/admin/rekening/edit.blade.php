                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="bank_edit" class="form-label">Nama Bank</label>
                            <input type="text" id="bank_edit" name="bank" class="form-control" >
                            <span id="bank_error_edit" class="text-danger"></span>
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="name_edit" class="form-label">Atas Nama</label>
                            <input type="text" id="name_edit" name="name" class="form-control">
                            <span id="name_error_edit" class="text-danger"></span>
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="norek_edit" class="form-label">Nomor Rekening</label>
                            <input type="number" id="norek_edit" name="norek" class="form-control">
                            <span id="norek_error_edit" class="text-danger"></span>
                        </div>
                    </div>
                </div>
