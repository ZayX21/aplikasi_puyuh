        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <form id="editForm" method="post" action="{{ route('pelanggan.profileAct') }}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="nohp_edit" class="form-label">No Telepon</label>
                                    <input type="number" id="nohp_edit" name="nohp" class="form-control"
                                        placeholder="Masukkan Nomor HP Valid" value="{{ $user->pelanggan->no_hp }}" />
                                    <span id="nohp_error_edit" class="text-danger"></span>
                                </div>
